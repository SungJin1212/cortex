...
func NewBucketClient(cfg Config, hedgedTransport func(rt http.RoundTripper) http.RoundTripper, _ string, logger log.Logger) (objstore.Bucket, error) {
	...
	return swift.NewContainer(logger, serialized, hedgedTransport)
}
